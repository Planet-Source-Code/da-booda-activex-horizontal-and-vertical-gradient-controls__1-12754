VERSION 5.00
Begin VB.UserControl GradientVScroll 
   Alignable       =   -1  'True
   AutoRedraw      =   -1  'True
   ClientHeight    =   900
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   960
   PropertyPages   =   "GradientVScroll.ctx":0000
   ScaleHeight     =   900
   ScaleWidth      =   960
   ToolboxBitmap   =   "GradientVScroll.ctx":0021
End
Attribute VB_Name = "GradientVScroll"
...
'*********************************
'
' Vertical Gradiant ScrollBar V 1.1
' Nov 2000
...
Dx = Y / Screen.TwipsPerPixelY 'Find the mouse x and convert to pixels
Dx = Dx / St 'divide by cell size
V = Mx - Dx 'subtract new x from mn and thats your value
...
'no hair left after that incident.
...
UserControl.Height = (((Mx - Mn + 1) * St) + 2) * Screen.TwipsPerPixelX
...
For a = V - Mn To 0 Step -1 'go from the begining to the end of bar
b = a * St 'calculate cell size
b = Mx * St - b
'Draw the cell
UserControl.Line (1 * Screen.TwipsPerPixelX, (1 + b) * Screen.TwipsPerPixelY)-(X, (1 + b + St - 1) * Screen.TwipsPerPixelY), RGB(Sr + (a * Pr), Sg + (a * Pg), Sb + (a * Pb)), BF
'if cell is bigger than one the outline with backcolor
If CO = True And St > 2 Then
UserControl.Line (1 * Screen.TwipsPerPixelX, (1 + b) * Screen.TwipsPerPixelY)-(X, (1 + b + St - 1) * Screen.TwipsPerPixelY), RGB(Br, Bg, Bb), B
End If
Next a
'this sets up the white box to go around the current value
If BarVisible = True Then
b = (V - Mn) * St
b = Mx * St - b
If BarSolid = False Then
UserControl.Line (1 * Screen.TwipsPerPixelX, (1 + b) * Screen.TwipsPerPixelY)-(X, (1 + b + St - 1) * Screen.TwipsPerPixelY), RGB(Rr, Rg, Rb), B
Else:
UserControl.Line (1 * Screen.TwipsPerPixelX, (1 + b) * Screen.TwipsPerPixelY)-(X, (1 + b + St - 1) * Screen.TwipsPerPixelY), RGB(Rr, Rg, Rb), BF
End If
End If
'Draw out line
UserControl.Line (0, 0)-(UserControl.Width - 1 * Screen.TwipsPerPixelX, UserControl.Height - 1 * Screen.TwipsPerPixelY), RGB(Lr, Lg, Lb), B
End Sub
...
Attribute StartRed.VB_ProcData.VB_Invoke_Property = "VGColor"
...
Attribute StartGreen.VB_ProcData.VB_Invoke_Property = "VGColor"
StartGreen = Sg
End Property
...
Attribute StartBlue.VB_ProcData.VB_Invoke_Property = "VGColor"
StartBlue = Sb
End Property
...
Attribute EndRed.VB_ProcData.VB_Invoke_Property = "VGColor"
EndRed = Er
End Property
...
Attribute EndGreen.VB_ProcData.VB_Invoke_Property = "VGColor"
EndGreen = Eg
End Property
...
Attribute EndBlue.VB_ProcData.VB_Invoke_Property = "VGColor"
EndBlue = Eb
End Property
...
Attribute Max.VB_ProcData.VB_Invoke_Property = "VGSize"
Max = Mx
End Property
...
Attribute Min.VB_ProcData.VB_Invoke_Property = "VGSize"
Min = Mn
End Property
...
Attribute BoxRed.VB_ProcData.VB_Invoke_Property = "VGColor"
BoxRed = Lr
End Property
...
Attribute BoxGreen.VB_ProcData.VB_Invoke_Property = "VGColor"
BoxGreen = Lg
End Property
...
Attribute BoxBlue.VB_ProcData.VB_Invoke_Property = "VGColor"
BoxBlue = Lb
End Property
...
Attribute BackRed.VB_ProcData.VB_Invoke_Property = "VGColor"
BackRed = Br
End Property
...
Attribute BackGreen.VB_ProcData.VB_Invoke_Property = "VGColor"
BackGreen = Bg
End Property
...
Attribute BackBlue.VB_ProcData.VB_Invoke_Property = "VGColor"
BackBlue = Bb
End Property
...
Attribute BarRed.VB_ProcData.VB_Invoke_Property = "VGColor"
BarRed = Rr
End Property
...
Attribute BarGreen.VB_ProcData.VB_Invoke_Property = "VGColor"
BarGreen = Rg
End Property
...
Attribute BarBlue.VB_ProcData.VB_Invoke_Property = "VGColor"
BarBlue = Rb
End Property
...
Attribute BarVisible.VB_ProcData.VB_Invoke_Property = "VGSize"
BarVisible = BV
End Property
...
Attribute BarSolid.VB_ProcData.VB_Invoke_Property = "VGSize"
BarSolid = BS
End Property
...
Attribute Step.VB_ProcData.VB_Invoke_Property = "VGSize"
Step = St
End Property
...
Attribute Value.VB_ProcData.VB_Invoke_Property = "VGSize"
Value = V
End Property
